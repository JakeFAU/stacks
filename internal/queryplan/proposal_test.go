...
func TestComposeRequestRejectsInvalidWireShapes(t *testing.T) {
	tests := []struct {
		...
		{"alternate case top level field", strings.Replace(executablePointProposal, `"status": "executable"`, `"Status": "executable"`, 1)},
		{"alternate case nested field", strings.Replace(executablePointProposal, `"kind": "point"`, `"Kind": "point"`, 1)},
		{"case variant duplicate top level field", strings.Replace(executablePointProposal, `"status": "executable",`, `"status": "executable", "Status": "executable",`, 1)},
		{"case variant duplicate nested field", strings.Replace(executablePointProposal, `"at": "2026-06-01T12:00:00-04:00",`, `"at": "2026-06-01T12:00:00-04:00", "At": "2026-06-01T12:00:00-04:00",`, 1)},
